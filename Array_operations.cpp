/*
Question:
Design and implement a program to read, display, insert, update and       
delete operations on data objects for customer information supply chain management system using array.
